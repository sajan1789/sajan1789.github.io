...
const Contact = () => {
  return (
    ...
    data-aos-once="false"
    data-aos-anchor-placement="top-center">
          <Link href="https://github.com/sajan1789"> <Button className='btn2' bg="#A0AEC0" ><Icon  w={[4,5]} h={12} as={BsGithub}/></Button></Link> 
          <Link href="https://www.linkedin.com/in/sajan-kumar-gupta/">  <Button className='btn2' colorScheme="linkedin" ml="20px" ><Icon  w={[4,5]} h={12} as={BsLinkedin} /></Button></Link>
           <Link href="tel:+917903661341"> <Button className='btn2' bg="#48BB78" ml="20px"><PhoneIcon  w={[4,5]} h={12} /></Button></Link>
           <Link href="mailto:sajan99559@gmail.com"> <Button className='btn2'  bgGradient={[
