...
const Projects = () => {
  return (
    ...
    data-aos-anchor-placement="top-center"> 
                    ...
                    <div className='project-card-'>
                     ...
                     <Link target="_blank" className='project-deployed-link' href="https://tata-cliq-clone.vercel.app/"> <Button  fontSize={{base:'0.8em'}} className='btn' color="white"  mb="15px" bg="#E53E3E">Website</Button></Link>  
                     <Link target="_blank" className='project-github-link' href="https://github.com/blackcode1996/Tata-Cliq-clone">  <Button  fontSize={{base:'0.8em'}} className='btn' color="white"  bg="black" ml="10px" mb="15px"> Github<Icon as={BsGithub} /></Button></Link>  
    ...
    data-aos-anchor-placement="top-center">
                 ...
                 <Link target="_blank" className='project-deployed-link' href="https://furnituretry-official.netlify.app/">  <Button fontSize={{base:'0.8em'}} className='btn' mb="20px" color="black" bg="white">web</Button></Link>
                 <Link target="_blank" className='project-github-link' href="https://github.com/prateek-bka/lazy-hose-3359"> <Button fontSize={{base:'0.8em'}} mb="20px"  className='btn' color="white" bg="black" ml="10px"> Github<Icon as={BsGithub} /></Button></Link>
  ...
  data-aos-anchor-placement="top-center">
                    ...
                    <div className='project-card-'>
                     ...
                     <Link target="_blank" className='project-deployed-link' href="https://comfy-dragon-c64b1f.netlify.app/"> <Button  fontSize={{base:'0.8em'}} className='btn' color="white" bgGradient='linear(to-l, ,purple,#7928CA, #FF0080)'>Website</Button></Link>  
                     <Link target="_blank" className='project-github-link' href="https://github.com/rittik24/Zee5.com.clone">  <Button  fontSize={{base:'0.8em'}} className='btn' color="white"  bg="black" ml="10px"> Github<Icon as={BsGithub} /></Button></Link>  
