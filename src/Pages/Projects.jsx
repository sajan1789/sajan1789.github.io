...
const Projects = () => {
  return (
    ...
    data-aos-anchor-placement="top-center">
                 ...
                 <Link href="https://drive.google.com/file/d/1oHF4pgDOvReUdcor_8KQ0syIy3FEcfCL/view">  <Button fontSize={{base:'0.8em'}} className='btn' mb="20px" color="black" bg="white">web</Button></Link>
                 <Link href="https://github.com/sajan1789/Grbitz.com_Clone/tree/main/my-app"> <Button fontSize={{base:'0.8em'}} mb="20px"  className='btn' color="white" bg="black" ml="10px"> Github<Icon as={BsGithub} /></Button></Link>
  ...
  data-aos-anchor-placement="top-center">
                    ...
                    <div className='ProjectD'>
                     ...
                     <Link href="https://github.com/sajan1789/Ecommerce-webside">  <Button  fontSize={{base:'0.8em'}} className='btn' color="white"  bg="black" ml="10px"> Github<Icon as={BsGithub} /></Button></Link>  
    ...
    data-aos-anchor-placement="top-center">
                ...
                <Link href="https://github.com/sajan1789/Grbitz.com_Clone/tree/main/my-app">  <Button  fontSize={{base:'0.8em'}} className='btn' color="white"  mb="20px" bg="black" ml="10px"> Github<Icon as={BsGithub} /></Button></Link>  
                     </div>
