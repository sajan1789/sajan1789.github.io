...
const Skills = () => {
  ...
  return (
    ...
    data-aos-anchor-placement="top-center" >
                 ...
                 <Box boxShadow= "4px 4px #76E4F7, -0em 1px .4em #76E4F7">
                 ...
                 <Box boxShadow= "4px 4px #A0AEC0, -0em 1px .4em #A0AEC0" >
                 <img src="https://chiranjeev-thapliyal.vercel.app/svg/nodejs.svg" />
                  <h1 style={{color:"#A0AEC0"}}>Node JS</h1>
                 </Box>
                 <Box  boxShadow= "4px 4px #48BB78, -0em 1px .4em #48BB78" ><img src="https://chiranjeev-thapliyal.vercel.app/svg/mongodb.svg" />
                  <h1 style={{color:"#48BB78"}}>MongoDB</h1></Box>
                 <Box  boxShadow= "4px 4px #718096, -0em 1px .4em #718096" >
                 ...
                 <Box boxShadow= "4px 4px #EBF8FF, -0em 1px .4em #EBF8FF"  >
